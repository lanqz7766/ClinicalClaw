...
class ClinicalClawSettings(BaseSettings):
    ...
    database_path: str = Field(default=".clinicalclaw/state.db", alias="CLINICALCLAW_DATABASE_PATH")
    log_level: str = Field(default="info", alias="CLINICALCLAW_LOG_LEVEL")
    memory_history_limit: int = Field(default=3, alias="CLINICALCLAW_MEMORY_HISTORY_LIMIT")
